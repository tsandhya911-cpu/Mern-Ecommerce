...
//     return (
//         <div className="bg-gradient-to-br from-purple-50 to-pink-50 min-h-screen py-6 px-4">

//             <div className="max-w-6xl mx-auto">

//                 {/* HEADER */}
//                 <h1 className="text-3xl md:text-4xl font-extrabold text-center bg-gradient-to-r from-pink-500 to-purple-500 text-transparent bg-clip-text mb-8">
//                     Checkout 🛍
//                 </h1>
...
//                     {/* RIGHT SUMMARY */}
//                     <div className="bg-white p-6 rounded-3xl shadow-lg border h-fit md:sticky md:top-24">
...
//                             <div
//                                 key={item._id}
//                                 className="flex justify-between mb-3 bg-gray-50 p-3 rounded-lg"
//                             >
