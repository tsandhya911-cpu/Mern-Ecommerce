...
//       {/* LEFT */}
//       <div className="hidden md:flex md:w-1/2 bg-gradient-to-br from-pink-500 to-purple-600 text-white items-center justify-center flex-col p-6">
//         <h1 className="text-3xl lg:text-5xl font-extrabold mb-4 text-center">
//           Welcome Back 💖
//         </h1>
//         <p className="text-sm lg:text-lg opacity-90 text-center">
//           Login to continue shopping with ShopEasy
//         </p>
//       </div>

//       {/* RIGHT */}
//       <div className="flex w-full md:w-1/2 justify-center items-center bg-white py-6 px-3 sm:px-6">

//         <form
//           onSubmit={handleSubmit}
//           className="w-full max-w-sm sm:max-w-md bg-white p-4 sm:p-6 md:p-8 rounded-2xl shadow-xl space-y-4 sm:space-y-5 border"
//         >

//           <h2 className="text-2xl sm:text-3xl font-bold text-center text-pink-500">
//             Login
//           </h2>
...
//               className="mt-1 w-full border p-2 sm:p-3 text-sm sm:text-base rounded-lg focus:ring-2 focus:ring-pink-400 outline-none"
//             />
//           </div>
...
//               className="mt-1 w-full border p-2 sm:p-3 text-sm sm:text-base rounded-lg focus:ring-2 focus:ring-purple-400 outline-none"
//             />
//           </div>
...
//           <button
//             disabled={loading}
//             className={`w-full py-2 sm:py-3 rounded-lg text-white font-semibold
//             ${loading
//                 ? "bg-gray-400"
